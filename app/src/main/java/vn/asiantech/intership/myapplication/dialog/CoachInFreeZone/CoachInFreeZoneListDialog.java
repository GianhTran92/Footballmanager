package vn.asiantech.intership.myapplication.dialog.CoachInFreeZone;
...
public class CoachInFreeZoneListDialog extends Dialog implements LoadListCoachInFreeZoneInterface {
    ...
    public void loadSuccess(List<Coach> coaches) {
        ...
        RecyclerViewCoachInFreeZoneAdapter playerFreeRecyclerViewAdapter =
                new RecyclerViewCoachInFreeZoneAdapter(coaches);


        mRecyclerViewCoachInFreeZone.setAdapter(playerFreeRecyclerViewAdapter);
    }
